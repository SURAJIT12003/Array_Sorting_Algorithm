...
public class Bubble_Sort{
    ...
    public static void bubbleSort(int[] arr){
       ...
       for(int i=0; i<n; i++){ // for every element run loop o(n)time loop.
          ...
          // this condition only for sorted arrays every time at least one swap is needed. If no swap then the array already sorted .So for Sorted Arrays this algorithm TIME COMPLEXITY is -0(N)
          if(swap==0){  
            break;
          }
